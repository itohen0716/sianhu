(function(global){
  ...
  function render(state,options={}){
    ...
    rows.forEach(item=>{item.lyrics=state.lyricsMode?String(state.lyrics?.[item.row]||""):""});
